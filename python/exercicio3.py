# Exercício 3 – (1.0 ponto) – Elaborar um algoritmo para ler uma frase qualquer. Deve-se:  
# Imprimir as letras que se encontram nas posições pares da frase (posições 0,2,4,6,8, ...);  
